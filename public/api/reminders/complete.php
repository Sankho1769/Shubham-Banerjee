...
try {
    (new ReminderService())->complete($id, $userId);
    Response::success([]);
    ...
    \App\Helpers\Logger::error('Reminder complete failed', ['error' => $e->getMessage()]);
    Response::error('Could not complete the reminder.', 500);
}
